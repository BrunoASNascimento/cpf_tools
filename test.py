...
class TestCpf(unittest.TestCase):
    ...
    def test_cpf_format(self):
        self.assertEqual(cpf_format(cpf=46374367880.0), '463.743.678-80')
        self.assertEqual(cpf_format(cpf=46374367880), '463.743.678-80')
        self.assertEqual(cpf_format(cpf=4.637437e+10), '463.743.700-00')
        self.assertEqual(cpf_format(
            cpf='5*7das4.71dads1.8-35'), '005.747.118-35')
